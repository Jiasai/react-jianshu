...
const useListState = ()=>{ //这里面不可以直接定义变量，必须要写函数 才行
       ...
       //假定发送http请求，得到listData、recommentList 数据
        ...
        const getRecommentData=async()=>{
            return[
                {id:1,imgUrl:"https://cdn2.jianshu.io/assets/web/banner-s-daily-e6f6601abc495573ad37f2532468186f.png"},
                {id:2,imgUrl:"https://cdn2.jianshu.io/assets/web/banner-s-club-aa8bdf19f8cf729a759da42e4a96f366.png"},
                {id:3,imgUrl:"https://cdn2.jianshu.io/assets/web/banner-s-7-1a0222c91694a1f38e610be4bf9669be.png"},
                {id:4,imgUrl:"https://cdn2.jianshu.io/assets/web/banner-s-5-4ba25cf5041931a0ed2062828b4064cb.png"}
            ]
        }
        useEffect(()=>{   
            //修改数据
    ...
    return {articleList,setArticleList,recommentList,setRecommentList};
}
